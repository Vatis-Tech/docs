...
For this kind of stream, the data is persisted for about 3 hours before being deleted. This time may increase with up to 1 hour depending on the load on the system.
