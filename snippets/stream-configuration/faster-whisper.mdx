<ParamField query="language" type="string" default="none">
    The language as country [ISO code](/api-reference/auxiliaries/transcription-languages) to transcribe the audio to. When not specified, it is automatically detected.
</ParamField>
